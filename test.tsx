...
describe('react2angular', () => {
  ...
  describe('react stateless components', () => {
    ...
    it('should support multiple children', () => {
      ...
      const element = $(`<test-angular-two foo="foo" bar="bar" baz="baz"><h1>transcluded</h1><h2>transcluded</h2></test-angular-one>`)
      $compile(element)(scope)
      $rootScope.$apply()
      expect(element.find('h1').length).toBe(1)
      expect(element.find('h1').text()).toBe('transcluded')
    ...
    it('should support transclusion of other components', () => {
      ...
      const element = $(`<test-angular-two foo="foo" bar="bar"><test-angular-two foo="foo" bar="bar"></test-angular-two></test-angular-one>`)
      $compile(element)(scope)
      $rootScope.$apply()
      expect(element.find('div').length).toBe(2)
      expect(element.find('p').length).toBe(6)
    ...
    it('should update with children', () => {
      ...
      const element = $(`<test-angular-two foo="foo" bar="bar"><span>{{foo}}</span></test-angular-one>`)
      $compile(element)(scope)
      $rootScope.$apply()
      expect(element.find('span').text()).toBe('1')
